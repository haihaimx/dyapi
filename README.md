...
[![GitHub issues](https://img.shields.io/github/issues/Evil0ctal/Douyin_TikTok_Download_API?style=flat-square)](https://web.chatcm.top/)
[![GitHub closed issues](https://img.shields.io/github/issues-closed/Evil0ctal/Douyin_TikTok_Download_API?style=flat-square)](https://web.chatcm.top/?q=is%3Aissue+is%3Aclosed)
...
<br>
[![API status](https://img.shields.io/website?down_color=lightgrey&label=API%20Status&down_message=API%20offline&style=flat-square&up_color=%23dfb9ff&up_message=online&url=https%3A%2F%2Fapi.douyin.wtf%2Fdocs)](https://web.chatcm.top/docs)
[![TikHub-API status](https://img.shields.io/website?down_color=lightgrey&label=TikHub-API%20Status&down_message=API%20offline&style=flat-square&up_color=%23dfb9ff&up_message=online&url=https%3A%2F%2Fapi.tikhub.io%2Fdocs)](https://api.chatcm.top/docs)
<br>
...
🍟API Document: [https://web.chatcm.top/docs](https://web.chatcm.top/docs)

🌭TikHub API Document: [https://api.chatcm.top/docs](https://api.chatcm.top/docs)
...
- 解析作者主页内所有视频([TikHub-API](https://api.chatcm.top/docs) 支持抖音/TikTok)
- 解析视频内所有评论信息([TikHub-API](https://api.chatcm.top/docs) 支持抖音/TikTok)
...
- [ ] TikHub-API添加对hash_tag页面的数据爬取 [#101](https://web.chatcm.top//101)
...
> 💡提示：包含但不仅限于以下例子，如果遇到链接解析失败请开启一个新 [issue](https://web.chatcm.top/)
...
在线：[https://web.chatcm.top/docs](https://web.chatcm.top/docs)

***TikHub-API文档：***

在线：[https://api.chatcm.top/docs](https://api.chatcm.top/docs)
