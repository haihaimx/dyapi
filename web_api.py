...
- 如果需要更多接口，请查看[https://api.chatcm.top/docs](https://api.chatcm.top/docs)。
- 本项目开源在[GitHub：Douyin_TikTok_Download_API](https://github.com/Evil0ctal/Douyin_TikTok_Download_API)。
- 全部端点数据均来自抖音以及TikTok的官方接口，如遇到问题或BUG或建议请在[issues](https://web.chatcm.top/)中反馈。
- 本项目仅供学习交流使用，严禁用于违法用途，如有侵权请联系作者。
> [英文/English]
- Crawl the data of Douyin and TikTok and return it. More features are under development.
- If you need more interfaces, please visit [https://api.chatcm.top/docs](https://api.chatcm.top/docs).
...
async def root():
    ...
    data = {
        ...
        "API_V1_Document": "https://web.chatcm.top/docs",
        "TikHub_API_Document": "https://api.chatcm.top/docs",
